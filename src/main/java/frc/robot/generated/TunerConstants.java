    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                // Stator limit caps motor torque (slip protection, matches kSlipCurrent)
                .withStatorCurrentLimit(Amps.of(60))
                .withStatorCurrentLimitEnable(true)
                // Supply limit caps current drawn from the PDP — critical for main breaker protection
...
//    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(1);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.16845703125);
